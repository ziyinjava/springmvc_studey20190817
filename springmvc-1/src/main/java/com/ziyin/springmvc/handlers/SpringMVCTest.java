package com.ziyin.springmvc.handlers;

import com.ziyin.springmvc.entities.User;
...
public class SpringMVCTest {
    ...
    public void getUser(@RequestParam(value="id",required=false) Integer id,
        ...
        if(id != null){
            //模拟从数据库中获取对象
            User user = new User(1, "Tom", "123456", "tom@ziyin.com", 12);
    ...
    public String testSessionAttributes(Map<String, Object> map){
        User user = new User("Tom", "123456", "tom@ziyin.com", 15);
        map.put("user", user);
        map.put("school", "ziyin");
        return SUCCESS;
    }
