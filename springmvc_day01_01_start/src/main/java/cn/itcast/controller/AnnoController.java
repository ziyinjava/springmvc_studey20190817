...
public class AnnoController {
    ...
    public String testRequestBody(@RequestBody String body){ //拿整个请求体的内容
        System.out.println("执行了...");
     ...
     * @return
     */
    @RequestMapping(value="/testPathVariable/{id}") //如果占位符名称和方法参数名不匹配, 就需要在@PathVariable注解的name或value属性中明确指定占位符名称
